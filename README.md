...
This property tells TypeScript where the type definitions for this package is, so that if
...
* `strict`: this is a matter of opinion: how strict we want TypeScript to be. Up to you...
